<nav class="topnav navbar navbar-light">
    ...
    <ul class="nav">
        <li class="flex justify-center mx-4 align-middle row nav-item dropdown">
            <x-multi-language-button></x-multi-language-button>
        </li>
        ...
        <li class="nav-item dropdown">
            <a class="pr-0 nav-link dropdown-toggle text-muted" href="#" id="navbarDropdownMenuLink"
                ...
                <span class="mt-2 avatar avatar-sm">
                    <img src="{{ asset('dashboard_assets') }}/assets/avatars/face-1.jpg" alt="..."
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                ...
                <a class="dropdown-item" href="javascript:$('#del-form').submit()">{{ __('messages.logout') }}</a>
                <form action="{{ route('dashboard.logout') }}" method="post" id="del-form" hidden>@csrf</form>
            </div>
        </li>
    </ul>
</nav>
